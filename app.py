...
city_advice_db = {
    ...
    "平顶山": {"m1": "【系统数据分析与推演过程】：底层面板对比数据显示，平顶山拥有全样本中处于绝对高位的浅层宽带普及度（高达601万户），且深层光缆基数达2031公里，其整体硬件网络底座表现出高度扎实的重资产沉淀特征。然而，系统因果矩阵的雷达图测度却检测出，该市外资引入量（1.02亿）与普惠金融渗透率处于极度枯竭的边缘象限。这种不对称的拓扑演化过程直观指出，该市当前正面临极为严重的“重资产过剩、软技术断层”双重危机。虽然空有庞大且耗能的通信光缆资产，却极度缺乏具备国际先进低碳管理体系的外资力量注入，以及本土高端数字智力生态的支撑，导致现有的底层重资产处于低效乃至算力空转的闲置边缘。\n\n【宏观政策指导方案】\n\n1. 招商结构调优：全面转向定向吸引携带前沿减排专利与算法模型的国际高质量数字技术企业入驻。\n2. 存量资产激活：强力指导市属大型能源国企开放应用场景，优先购买软件SaaS服务以盘活底层闲置网络。"},
    "安阳": {"m1": "【系统数据分析与推演过程】：作为典型老工业基地，安阳在碳足迹溯源与面板测度中呈现出全样本排名前列的巨量碳排承压（高达102.41Mt）。雷达图谱与极差测度引擎深度解析显示，尽管该市信息光缆基数达到了样本中游水位（1887公里），但如果将其与本地区庞大且沉重的钢铁、煤化工业物理体量相除求得单位载荷率，则当前的数字要素赋能深度存在极其严重的历史欠账与投入倒挂。断层推演矩阵直观标红了其数字化工具在向重型冶炼企业底层车间渗透过程中的严重不足。这种底层工业物联网与信息传输能力的绝对性亏欠，构成了目前区域高位碳排数据无法实现精细化测度、算法调度与系统性收敛的根本物理阻碍。\n\n【宏观政策指导方案】\n\n1. 历史包袱量化申诉：依托极差测度底稿，将断层报告转化为申报国家级老工业基地转型示范区的强力论证附件。\n2. 技改专项定向注资：联合外部大资本设立针对特钢等传统高排产业的数字化技改专项基金，通过强力杠杆填补深层算力缺位。"},
    "鹤壁": {"m1": "【系统数据分析与推演过程】：系统全域极差拓扑映射与欧氏距离比对显示，鹤壁市在决定产业转型的底层硬件要素（长途光缆仅549公里，全样本垫底）与智力软性要素（IT高级人才仅0.13万人，外资生态几乎归零）上，呈现出令人警惕的“双重严重塌陷”病态分布。推演模型直观且冷峻地指出，该区域的信息传输动脉极其微弱，不仅浅层消费端的宽带网络尚未完成高质量的全面普及，其支撑重工业与能源产业完成底层转型的深层物理基座更是处于全域的极度匮乏状态。这种“一穷二白”的初始要素底盘，从根本上剥夺了该区域在短期内自发构建复杂降碳算法体系与闭环数据控制架构的物理可行性。\n\n【宏观政策指导方案】\n\n1. 财政缺口理论辩护：将本断层诊断报告作为客观量化证据，合法合理地向上级争取跨区域转移支付以填补底层基建历史欠账。\n2. 孤岛式示范标杆：坚决摒弃“撒胡椒面”式的平均建设，集中极端有限的资源在核心龙头企业内部打造局域物联网孤岛试点。"},
    "长治": {"m1": "【系统数据分析与推演过程】：长治在本次高维雷达拓扑检测中呈现出极其特殊且畸形的“非对称性巨峰”。数据降维穿透表明，其深层长途光缆铺设里程长达3255.51公里，实际利用外资存量更是高达31.14亿元，表明其具备了极其雄厚的物理基建沉淀与外部资本输入盘面。然而，与这庞大硬件与资金规模形成剧烈反差的是，其IT核心人才密度仅有0.30万人。系统调用柱状断层推演矩阵尖锐地指出：该市存在严重的“硬件设备极其超前、资本流极度充沛，但智力核心运转域完全脱节”的异构断层现象。大量外资引入的先进降耗设备与庞大光纤网络，正面临着无人深度开发、无高级算法驱动控制的“高规格半闲置”状态。\n\n【宏观政策指导方案】\n\n1. 招才引智绝对优序：立刻将施政重心从重资产投入全面转向设立专项数字工程师引进计划，以承接庞大的硬件底座。\n2. 技术生态强制耦合：依托高位外资存量，强制要求外资企业在本土设立研发中心，通过人才属地化强行补齐系统智力短板。"},
    "晋城": {"m1": "【系统数据分析与推演过程】：晋城以161.18Mt的惊人碳排放量绝对极值，成为全域推演面板中特征最为显著的“重度高危碳锁定”样本。然而，雷达拓扑图谱与极差测度矩阵极其残酷地显示：面对这头体量骇人、惯性极强的“碳排放巨兽”，该区域用于制衡与调度的数字对抗要素却显得微乎其微（深层光缆仅2207公里，核心人才仅0.26万）。系统的断层推演矩阵直观标红了全要素体系的结构性枯竭。客观诊断结果明确指出：这种极度悬殊的“排量体量-数字控制力”比例，意味着该市现有的数字化赋能水平在如此庞大的煤炭与冶炼巨无霸面前，犹如杯水车薪，系统已近乎完全丧失了底层能耗调控与降耗因子深度渗透的能力。\n\n【宏观政策指导方案】\n\n1. 宏观缺口向上破局：将极端断层报告直接转化为申请“资源型城市深度低碳转型特区”的佐证，引入超常规国家级转移支付。\n2. 强制级基座重构：针对大型排碳主体的底层信息管网，下发带有强制性的重资产物联网更新指令，不设过渡缓冲期。"},
    "郑州": {"m1": "【系统数据分析与推演过程】：通过多维高阶空间拓扑矩阵映射，郑州作为国家中心城市与综合枢纽，其雷达特征图谱呈现出全样本中最具统治力的“软实力霸权”结构。其数字产业与IT智力资本密度高达10.99万人（呈现断层式领先），普惠金融发展指数与外资开放引入规模均处于全域面板的巅峰极值区域。然而，其深层物理光缆（1943公里）相对于其庞大且复杂的第三产业经济体量而言，仅表现为“适度够用”而非盲目扩张。系统综合诊断确证：该市已彻底且成功地摆脱了依赖铺设物理硬基建去拉动数字化转型的初级粗放阶段，全面迈入了以底层算法优化、跨域算力调度与智力资本要素为核心驱动力的深度治理区。\n\n【宏观政策指导方案】\n\n1. 顶层研发绝对导向：彻底剥离土建工程的财政依赖，全盘转向对人工智能大模型、零碳数据交易中台的顶层设计投入。\n2. 智力资源在地转化：出台专项“算力券”与“碳普惠”政策，将庞大的软开发大军就地转化为数字降碳产业输出的技术护城河。"},
    "洛阳": {"m1": "【系统数据分析与推演过程】：作为具备深厚老工业基因的综合型城市，洛阳在本次空间极差拓扑演算中暴露出极其罕见且危险的“资产错位”现象。数据穿透追踪显示，其深层长途光缆总长高达3911公里，硬件网络底盘堪称奢华，且IT人才具备4.28万人的优良规模。但与之形成惨烈断层效应的是，其年度实际外资引入仅有1.30亿元。系统断层矩阵毫不留情地指出：洛阳正陷入“基建设施严重超前超配，但外部先进技术流与绿色资本流导入呈现严重梗阻”的内循环困局，巨量埋设的地下光缆资产由于缺乏高端国际数字生态的介入，正面临极大的算力空转、无效折旧与闲置沉淀风险。\n\n【宏观政策指导方案】\n\n1. 存量资产紧急唤醒：立即叫停市级骨干网络土木工程扩展，全面盘点摸底现有数字资产负荷率，严控无效重复建设。\n2. 靶向型绿色招商：依托现成的世界级高冗余网络底座，将政策重心全盘压在吸引具备国际ESG标准的智造外企上以盘活资产。"},
    "新乡": {"m1": "【系统数据分析与推演过程】：新乡在多维雷达拓扑测度中呈现出典型的“中等收入陷阱式”均值回归分布。其深层光缆长度、宽带普及规模等硬性底层指标，均严丝合缝地卡在全域样本的均线轨道附近。然而，在真正决定产业转型纵深的数字人才密度（仅0.49万）与外资开放程度（1.02亿）上，却暴露出了疲软乏力、后继无能的断层迹象。系统的综合测度诊断直击痛点：这种全科平庸、缺乏长板的体检报告，意味着该市的网络覆盖广度虽已基本达标，但极其缺乏能够深度重构实体制造业的高阶数字融合生态与顶尖算法架构，目前正处于高不成低不就、要素驱动力边际递减的发展胶着期。\n\n【宏观政策指导方案】\n\n1. 细分领域灯塔工程：放弃普遍广度的基建摊大饼模式，集中机动财力，在电池制造、生物医药等优势领域打造零碳数字绝对标杆。\n2. 外交靶向技术引进：引资策略实施精准打击，专盯能带来成套能耗管理SaaS系统与供应链碳认证的外向型数字平台服务商。"},
    "开封": {"m1": "【系统数据分析与推演过程】：开封市的雷达拓扑映射呈现出极具属地特征的轻量化结构。得益于文旅服务与轻质工业为主导的产业底色，其初始碳排放基数控制在极低的区间（仅11.61Mt，位于全样本低位区）。底层测度显示，其光缆敷设与宽带普及率，已在物理层面上完美支撑起当前城市的综合运行体量。然而，系统在多维断层推演中毫不客气地标出了外资与高阶IT人才的塌陷区。这从严肃的量化层面确认了该市当前的数字经济依然仅停留在表层的消费、票务与浅层结算阶段，系统内部极其缺乏能将城市文商旅农资源进行深度低碳化算法整合与数据变现的高级赋能要素。\n\n【宏观政策指导方案】\n\n1. 轻量级SaaS化转向：放弃重资产数据中心建设指标的规划争夺，全盘转向开发“全域零碳智慧文旅服务云平台”。\n2. ESG主题引资路线：利用低碳生态优势，重点向主打ESG（环境、社会治理）评级投资的国际文创基金及绿色低碳品牌引流。"},
    "许昌": {"m1": "【系统数据分析与推演过程】：通过全域极差拓扑的大样本比对，许昌市的雷达特征图谱暴露出了极其尖锐的“单维向度塌陷”。其在普惠金融指数等本土内生型指标上表现出良好的韧性，但实际使用外资量仅为惨淡的0.27亿元，几乎触及面板数据底盘。系统的高阶断层推演矩阵毫不留情地指出：该市在宏观数字经济转型进程中，正处于极其严重的“对外技术封闭与资本孤岛”状态。缺乏国际先进绿色外资的引入，意味着彻底切断了前沿低碳控制设备、成熟减排算法模型以及外部鲶鱼效应的刺激来源，这种生态级的断层将彻底锁死该市制造业向高端价值链与零碳域攀升的理论空间。\n\n【宏观政策指导方案】\n\n1. 考核权重极端调优：重构招商引资考核体系，将政绩权重全面倾斜于引进携带绿色供应链管理技术与节能专利的科技服务企业。\n2. 轻量型合作示范区：不再搞大而全的基础土建，依托底盘专门设立具备极高环保与数字化基准的中外绿色智造合作专区。"},
    "漯河": {"m1": "【系统数据分析与推演过程】：漯河在全样本高维空间中呈现出极度罕见的“超微型碳排地标”特征。其基准碳排仅有2.62Mt，这一全域绝对底谷数据与其中国食品名城的轻量化工业底色实现了完美吻合。其光缆长度与核心人才密度看似在雷达极坐标上呈现出全方位的“向心塌陷”。但系统的极差判定引擎敏锐地纠正了这一感官错觉：这不是历史欠账，而是极其合理的“产业适配”。在完全没有重型工业包袱的绿色轻资产底盘下，强行增加深层光缆不仅是严重的财政浪费，更是对优良生态的冗余破坏。该市唯一的真实约束短板在于高端人才储备的过度奇缺，这严重制约了千亿级轻工食品产业向现代智能溯源与自动化分拣演进的数据化步伐。\n\n【宏观政策指导方案】\n\n1. 抵制同质化重基建：理直气壮拒绝大型数字基建分摊指标，将预算全盘转向申请“食品安全全链路上链溯源工程”专项开发。\n2. 单点脑力购买战略：彻底抛弃底层代码人员招募思维，出台特规高薪政策，向外部直接购买解决轻工业智造瓶颈的算法架构师。"},
    "三门峡": {"m1": "【系统数据分析与推演过程】：三门峡在系统的全域雷达拓扑映射中，呈现出全样本最扭曲、结构最极端的“畸形断裂带”。其外资吸纳量高达惊人的36.88亿元（位列非省会中心城市的极值），且长途光缆长达2550公里，其硬件底座与资本输入均处于极其奢华的过剩状态。然而，与之相对应的核心IT人才密度，却惨烈地跌至0.21万人的全域面板绝对最低谷。系统断层推演矩阵发出疯狂的逻辑警报：巨量的外商绿色资本与先进的物理管网海量涌入，但本地生态竟然完全没有与之匹配的高阶工程技术人员去承接、去维护、去开发底层控制算法。这是极其严重的“有资本无大脑”的资源空转惨剧，大量外资引入的前沿设备正因缺乏本土智力调试而处于低效乃至闲置状态。\n\n【宏观政策指导方案】\n\n1. 非常规人才空降：将解决高端工程师缺口定为首要急控事项，不惜代价出台数字人才整建制挖引计划，激活存量沉睡设备。\n2. 第三方外包纾困：应对因配套奇缺导致的高位外资撤资风险，由政府出面全额购买第三方顶级IT外包服务免费提供给落户外企。"},
    "南阳": {"m1": "【系统数据分析与推演过程】：南阳在全样本特征矩阵中投射出了最令人战栗的“重度基建过载体质”。作为一个以农业与综合服务业为主的大市，其深层长途光缆总里程竟然达到了惊世骇俗的6805.99公里（处于全域断层式的第一极值）。然而，其外资投入规模可怜至1.91亿元，核心技术人才仅0.66万人。系统的断层诊断中枢拉响了最高级别的结构性赤字警报：该区域经历了一场规模空前且脱离实际的“物理硬件跃进”。海量超规格的空置光纤埋入地下陷入深度沉睡，由于极度缺乏外部技术流的导入与高端数据处理能力的接盘，这座城市的底层网络承载力已经严重溢出其实体经济实际需求的百倍量级之上。\n\n【宏观政策指导方案】\n\n1. 无效基建全面冰冻：彻查清算低效涉网市政土建工程，核清海量网络存量的真实载荷率，从源头上刹住脱离产业实际的土建冲动。\n2. 存量网络强制引流：出台存量网络资源强制特许经营与并网条例，逼迫属地边缘政企应用强行向既有闲置干线管道内引流以实现资产止血。"},
    "濮阳": {"m1": "【系统数据分析与推演过程】：濮阳在多维雷达拓扑测度中呈现出极其典型的“低水平内卷式均衡”。其碳排放基数被压制至9.52Mt，客观反映出传统资源型产业衰退与出清后的物理现实。然而，其深层光缆、IT人才与外资引入三项核心数字动能指标，均毫无悬念地处于全域样本的末端象限。系统断层推演矩阵极其客观且冷酷地指出：该市既没有沉重的碳基数历史包袱，也没有冗余的基建负债压力，但同样完全丧失了数字化转型的先发势能窗口。这是一种严重缺乏外部技术血液注入、单纯依靠内生微弱经济循环维持的结构性数字化贫血状态。\n\n【宏观政策指导方案】\n\n1. 放弃重基座竞逐：放弃对标核心城市的宏大物理IDC基建规划，转而合法争取省级层面的算力调拨与干线网络公有云免费接入。\n2. 纯应用级外采策略：招商全面放弃“重资产大项目”执念，将机动预算全数转为补贴本土小微企业跨区购买成熟的SaaS解决方案。"},
...
def generate_dynamic_report(city_name, current_data, logic, module_key, c_inv, f_inv, i_inv):
    ...
    if module_key == "m2":
        ...
        fit_diagnosis = f"系统正在抓取您当前控制台输入的实时交互参数，与底层算法推演出的全局理论帕累托最优解开展空间坐标拟合比对，综合欧氏测度拟合度为 **{match_score:.1f}%**。"
...
if st.session_state.page == 'splash':
    ...
    st.markdown("<br><p style='text-align: center; color: #888888;'>正在加载 25市 面板数据底座与动态大模型推演引擎...</p>", unsafe_allow_html=True)
    time.sleep(2.0)
    ...
    with col_main:
        with st.container(border=True):
            category_opts = ["内置：重工锁定型城市", "内置：综合服务型城市", "外部：自定义录入数据"]
            cat_choice = st.radio("第一步：界定面板数据归属与底层产业结构类型", category_opts, index=category_opts.index(st.session_state.city_category))
            ...
            if cat_choice == "内置：重工锁定型城市":
                ...
                s_city_choice = st.selectbox("第二步：选择重工型推演城市靶点", available_cities, index=available_cities.index(s_city_choice) if s_city_choice in available_cities else 0)
            elif cat_choice == "内置：综合服务型城市":
                available_cities = df[df["类型"] == "综合服务型城市"]["城市"].tolist()
                s_city_choice = st.selectbox("第二步：选择综合服务型参照基准城市", available_cities, index=available_cities.index(s_city_choice) if s_city_choice in available_cities else 0)
            else:
                s_city_choice = st.text_input("第二步：设定系统推演目标标的名称", value=s_city_choice if s_city_choice not in df["城市"].tolist() else "未命名区域")
                ...
                st.session_state.custom_data["IT人才密度"] = c1.number_input("人才(万人)", value=float(st.session_state.custom_data["IT人才密度"]))
                st.session_state.custom_data["基准碳排"] = c2.number_input("基准碳排(Mt)", value=float(st.session_state.custom_data["基准碳排"]))
                st.session_state.custom_data["宽带普及"] = c1.number_input("宽带普及(万户)", value=float(st.session_state.custom_data["宽带普及"]))
                st.session_state.custom_data["普惠金融"] = c2.number_input("普惠金融指数", value=float(st.session_state.custom_data["普惠金融"]))
    ...
    with st.sidebar:
        ...
        new_cat = st.radio("一、底座数据类型热切换", cat_opts, index=cat_opts.index(st.session_state.city_category), key="sb_cat")

        if new_cat != "外部：自定义录入数据":
            avail = df[df["类型"] == new_cat.split("：")[1]]["城市"].tolist()
            new_city = st.selectbox("二、设定空间推演靶点", avail, index=avail.index(st.session_state.s_city) if st.session_state.s_city in avail else 0, key="sb_city")
            ...
            new_logic = st.radio("核定底层算法基盘", ["偏向重化工业主导", "偏向综合与服务型"], index=0 if "重化工" in st.session_state.custom_logic else 1, key="sb_logic")
            st.markdown("*（手动微调以下宏观底盘数据，实时触发图谱演算）*")
            c1, c2 = st.columns(2)
            new_n1 = c1.number_input("长途光缆(km)", value=float(st.session_state.custom_data.get("长途光缆", 1500.0)))
            new_n2 = c2.number_input("外资(亿元)", value=float(st.session_state.custom_data.get("外资引进与对外开放程度", 10.0)))
            new_n3 = c1.number_input("人才(万人)", value=float(st.session_state.custom_data.get("IT人才密度", 1.5)))
            new_n4 = c2.number_input("碳排总量(Mt)", value=float(st.session_state.custom_data.get("基准碳排", 50.0)))
            new_n5 = c1.number_input("宽带(万户)", value=float(st.session_state.custom_data.get("宽带普及", 200.0)))
            new_n6 = c2.number_input("普惠金融", value=float(st.session_state.custom_data.get("普惠金融", 280.0)))

            if (new_cat != st.session_state.city_category or new_city != st.session_state.s_city or new_logic != st.session_state.custom_logic or
                new_n1 != st.session_state.custom_data.get("长途光缆") or new_n2 != st.session_state.custom_data.get("外资引进与对外开放程度") or
                new_n3 != st.session_state.custom_data.get("IT人才密度") or new_n4 != st.session_state.custom_data.get("基准碳排") or
                new_n5 != st.session_state.custom_data.get("宽带普及") or new_n6 != st.session_state.custom_data.get("普惠金融")):
                
                st.session_state.city_category = new_cat; st.session_state.s_city = new_city; st.session_state.custom_logic = new_logic
                st.session_state.custom_data.update({"长途光缆": new_n1, "外资引进与对外开放程度": new_n2, "IT人才密度": new_n3, "基准碳排": new_n4, "宽带普及": new_n5, "普惠金融": new_n6})
                st.rerun()
    ...
    if st.session_state.page == 'menu':
        ...
        st.info("系统声明：内置高精度双重机器学习（OrthoIV-CF）与遗传运筹算法（NSGA-III）。本系统生成的文字描述、趋势图谱与政策匹配指导，均由您在左侧控制台输入的滑块参数通过底层算法引擎动态高频演算生成，为您提供极致严密的数学论证支撑。")
        for num, mod, title, desc in [("一", "mod1", "宏观体检与数据要素断层推演", "构建多维高阶极差矩阵，深度剥离揭示区域在数字底层基座与智力软性储备的结构性断层。"),
                                      ...
                                      ("四", "mod4", "全局多约束帕累托最优生成指令", "基于NSGA-III算法，在宏观约束下全盘计算最完美黄金比例，并对您当前配比实施实时纠偏指令。")]:
            with st.container(border=True):
                st.markdown(f"### {num}、 {title}")
                st.markdown(desc)
                if st.button(f"启动运算引擎进入模块{num}", key=mod, use_container_width=True): st.session_state.page = mod; st.rerun()
    ...
    # 模块一
        ...
        with col_left:
            ...
            fig_radar.update_layout(polar=dict(radialaxis=dict(visible=True, range=[0, 100])), height=350, title="宏观发展要素高维拓扑雷达映射", margin=dict(t=50, b=20, l=40, r=40))
            st.plotly_chart(fig_radar, use_container_width=True)
            df_gap = pd.DataFrame({"评估维度": categories, "区域考核得分": city_scores, "全域样本均线": avg_scores})
            fig_bar = px.bar(df_gap, x="评估维度", y=["全域样本均线", "区域考核得分"], barmode="group", title="核心资源要素物理存量极差推演", color_discrete_sequence=["#B0BEC5", C_DEEP_FOREST])
    ...
    # 模块二
        ...
        if current_engine_logic == "综合型":
            ...
            fig_heat.update_layout(title="综合型城域资金错配及过热风险热力二维推演", xaxis_title="硬基建参数(亿)", yaxis_title="软生态资本(亿)", height=350, margin=dict(t=40, b=10, l=10, r=10))
            fig_heat.add_trace(go.Scatter(x=[st.session_state.c_invest], y=[soft_invest], mode='markers+text', marker=dict(color='gold', size=16, symbol='star', line=dict(width=2, color='black')), text=["📍 实时推演动态坐标"], textposition="top center"))
            with col_left:
                fig_gauge = go.Figure(go.Indicator(mode="gauge+number", value=min(st.session_state.c_invest / 8.0 * 100, 100), title={'text': "基建冗余度与碳排反弹综合风险指数"},
            ...
            fig_heat.update_layout(title="重工锁定型城域势能积聚跨越拓扑预测图", xaxis_title="硬基建参数(亿)", yaxis_title="软生态资本(亿)", height=350, margin=dict(t=40, b=10, l=10, r=10))
            fig_heat.add_trace(go.Scatter(x=[st.session_state.c_invest], y=[soft_invest], mode='markers+text', marker=dict(color='gold', size=16, symbol='star', line=dict(width=2, color='black')), text=["📍 实时推演动态坐标"], textposition="top center"))
            with col_left:
                fig_gauge = go.Figure(go.Indicator(mode="gauge+number", value=min(total_invest / 6.5 * 100, 100), title={'text': "碳锁定破局与门槛跨越势能指数"},
    ...
    # 模块三
        ...
        df_traj = pd.DataFrame({"预测年度": years * 2, "核心排量监控值(Mt)": base_traj + [base_carbon, traj_1, traj_2, pred_carbon], "仿真演化情境": ["静态基准演化轨道"] * 4 + ["交互参数推演干预轨道"] * 4})

        col_left, col_right = st.columns([1.2, 1])
        with col_left:
            fig_line = px.line(df_traj, x="预测年度", y="核心排量监控值(Mt)", color="仿真演化情境", markers=True, title="中短期全域核心减排折线分轨模拟预测", color_discrete_sequence=["#9E9E9E", C_GLACIER_TEAL])
            fig_line.update_layout(height=350)
            st.plotly_chart(fig_line, use_container_width=True)

            x_l = ["基准碳排底座", "硬建空耗反弹", "外资技术红利", "软性智力红利", "预测推演落点"] if current_engine_logic == "综合型" else ["基准碳排底座", "施工附加能耗", "深层光缆红利", "外资技术迁移", "管理算法跃升", "预测推演落点"]
            ...
            fig_shap.update_layout(title="SHAP博弈论算法边际影响(ROI)定量剥离", showlegend=False, height=350, margin=dict(t=40, b=20, l=10, r=10))
    ...
    # 模块四 (重构的“田”字排版：分离拟合度诊断)
        ...
        with col_top_left:
            ...
            fig_3d.add_trace(go.Scatter3d(x=[total_invest], y=[base_carbon - pred_carbon], z=[-0.1 * (total_invest - 10) ** 2 + 8], mode='markers+text', text=["📍 动态测度坐标"], marker=dict(size=14, symbol='diamond', color='gold', line=dict(color='black', width=3)), textposition='top center'))
            fig_3d.update_layout(height=650, margin=dict(l=0, r=0, t=40, b=0))
        ...
        # 下半部分：拟合度诊断(左，图表正下方) + 政策指导(右，基础分析正下方)
        col_bot_left, col_bot_right = st.columns([1.2, 1])
        with col_bot_left:
            st.markdown(f"""
                <div style='background-color: #F8F9FA; border-left: 5px solid #2C3539; padding: 20px 25px; margin-top: 0px; margin-bottom: 25px; line-height: 1.8; font-size: 15px; text-align: justify; border-radius: 4px;'>
                    <h4 style='color: #2C3539; margin-top: 0px; margin-bottom: 15px; font-weight: bold;'>🎯 多目标决策拟合度深度诊断</h4>
                    <p style='margin-bottom: 0;'>{fit_part}</p>
                </div>
            """, unsafe_allow_html=True)

        with col_bot_right:
            st.markdown("<h3 style='color: #2C3539; font-weight: bold; margin-top: 0px; margin-bottom: 15px;'>🎯 宏观政策指导方案</h3>", unsafe_allow_html=True)
